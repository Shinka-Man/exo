...
model_cards = {
  ...
  "kimi-k2-4bit": { "layers": 61, "repo": { "MLXDynamicShardInferenceEngine": "/Users/lna/models/inferencerlabs/Kimi-K2-Instruct-MLX-3.985bit", }, },
  ### deepseek distills
  ...
  # Qwen3 MoE (local MLX)
  "qwen3-30b-a3b-8bit": { "layers": 48, "repo": { "MLXDynamicShardInferenceEngine": "/Users/lna/models/lmstudio-community/Qwen3-30B-A3B-Instruct-2507-MLX-8bit", }, },
  "qwen2-test": { "layers": 48, "repo": { "MLXDynamicShardInferenceEngine": "/Users/lna/models/lmstudio-community/Qwen3-30B-A3B-Instruct-2507-MLX-8bit", }, },
  ### nemotron
  ...
  # glm
  "glm-4.5-air-4bit": { "layers": 46, "repo": { "MLXDynamicShardInferenceEngine": "mlx-community/GLM-4.5-Air-4bit", }, },
  # dummy
...
pretty_name = {
  ...
  "glm-4.5-air-4bit": "GLM-4.5 Air (4-bit)",
  "qwen3-30b-a3b-8bit": "Qwen3 30B A3B (8-bit)",
}
